...
const IndustriesSection = dynamic(
  () => import('@/components/sections/what-we-do/IndustriesSection'),
  {
    ssr: false,
    loading: () => (
      <div className='py-16 md:py-24'>
...
export default function WhatWeDoPage() {
  ...
  return (
    <Layout
      title='What We Do'
      description='Comprehensive business solutions and industry expertise'
    >
      <ErrorBoundary>
        {/* Hero Section */}
        <section
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                  <div className='group flex items-center gap-3 text-white/70 hover:text-white transition-all duration-300 cursor-pointer p-3 rounded-lg hover:bg-gold/5 hover:scale-105'>
                    <div className='w-8 h-8 rounded-full bg-gold/20 group-hover:bg-gold/30 group-hover:scale-110 transition-all duration-300 flex items-center justify-center'>
                      <svg
                        className='w-4 h-4 text-gold group-hover:text-gold group-hover:scale-110 transition-all duration-300'
                        fill='currentColor'
                        viewBox='0 0 20 20'
                      >
                        <path
