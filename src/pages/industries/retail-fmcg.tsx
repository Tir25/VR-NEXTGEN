      ...
      <IndustryPageShell>
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <h1 className='text-4xl md:text-5xl font-bold text-white mb-6'>Retail & FMCG</h1>
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Customer experience and omnichannel strategies for retail and FMCG businesses to drive
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/images/Industries/Fmcg.png')",
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              ...
              <p className='text-gray-300 leading-relaxed mb-4'>
                Retail and FMCG companies thrive on agility.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                We help brands use data to anticipate demand, optimize stock, and maximize shelf
                performance — ensuring your business stays customer-ready at all times.
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                ...
                <li className='flex items-start gap-3'>
                  ...
                  <span className='text-gray-300'>
                    Sales Performance Dashboards and Price Analytics
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Distribution Efficiency and Route Optimization
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
