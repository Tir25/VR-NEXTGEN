      ...
      <IndustryPageShell>
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <h1 className='text-4xl md:text-5xl font-bold text-white mb-6'>Other Industries</h1>
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Specialized consulting solutions for diverse industries and unique business
              challenges.
            </p>
          </div>
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Custom Solutions for Diverse Business Ecosystems
              </h2>
              <p className='text-gray-300 leading-relaxed mb-6'>
                Whether it’s logistics, hospitality, or energy — we design custom analytics and
                process optimization solutions that fit your operational reality.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                Our approach ensures every business, regardless of size or sector, experiences
                measurable, data-led improvement.
              </p>
              <p className='text-white leading-relaxed text-lg'>
                🌐 If your business runs on data, we help it run better.
              </p>
            </div>
          </div>
        </div>
