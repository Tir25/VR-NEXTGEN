        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Risk management and digital banking solutions for financial institutions and insurance
              companies.
            </p>
          </div>
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/images/Industries/Financial.png')",
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Empowering Financial Clarity and Compliance
              </h2>
              <p className='text-gray-300 leading-relaxed mb-4'>
                Finance runs on accuracy, speed, and insight.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                We provide advanced analytics, automation, and reporting frameworks that help
                financial institutions manage risk, ensure compliance, and improve profitability.
              </p>
