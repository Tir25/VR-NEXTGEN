        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Operational excellence and supply chain optimization for manufacturing companies to
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/images/Industries/Manufacturing_Engineering.png')",
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Building Smarter, Leaner, and Connected Operations
              </h2>
              <p className='text-gray-300 leading-relaxed mb-4'>
                We help manufacturers eliminate inefficiencies, align operations, and implement Lean
                Six Sigma frameworks integrated with real-time dashboards.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                By connecting ERP, production, and maintenance systems, we create visibility across
                the value chain.
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                ...
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Preventive Maintenance and Resource Allocation Analytics
                  </span>
                </li>
              </ul>

              <p className='text-white leading-relaxed text-lg'>
                🏭 Turning traditional plants into data-smart factories.
              </p>
            </div>
          </div>
        </div>
