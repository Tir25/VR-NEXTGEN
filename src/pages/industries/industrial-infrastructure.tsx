        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Operational excellence and infrastructure optimization for industrial and
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              ...
              <p className='text-gray-300 leading-relaxed mb-4'>
                We partner with industrial and infrastructure firms to bring visibility and control
                to complex projects.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                Our analytics and project management tools ensure timely delivery, cost control, and
                resource efficiency.
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                <li className='flex items-start gap-3'>
                  ...
                  <span className='text-gray-300'>
                    Project Gantt Charts and Progress Dashboards
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Material, Cost, and Resource Utilization Analytics
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Delay Prediction and Risk Mitigation Frameworks
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Contractor and Vendor Performance Monitoring
                  </span>
                </li>
              </ul>

              <p className='text-white leading-relaxed text-lg'>
                🏗️ Engineering excellence through intelligence
              </p>
            </div>
          </div>
        </div>
