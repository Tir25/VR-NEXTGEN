        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Specialized consulting for healthcare organizations and hospitals to improve patient
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Enhancing Patient Outcomes Through Process and Data Excellence
              </h2>
              <p className='text-gray-300 leading-relaxed mb-4'>
                Healthcare transformation starts with operational efficiency and data transparency.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                We help hospitals and healthcare providers streamline processes, monitor
                performance, and improve patient experiences using smart dashboards and workflow
                redesign.
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                ...
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0' />
                  <span className='text-gray-300'>
                    Quality, Compliance, and Accreditation Reporting
                  </span>
                </li>
              </ul>
              ...
              <p className='text-gray-300 leading-relaxed mb-4'>
                Better patient satisfaction, faster service delivery, and reduced administrative
                inefficiencies.
              </p>
