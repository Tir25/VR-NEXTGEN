      ...
      <IndustryPageShell>
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <h1 className='text-4xl md:text-5xl font-bold text-white mb-6'>Education & EdTech</h1>
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Digital transformation and innovation solutions for education and EdTech companies to
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Building Smarter Institutions with Insightful Data
              </h2>
              <p className='text-gray-300 leading-relaxed mb-4'>
                Education is evolving — and so are the ways institutions manage performance.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                We help universities, schools, and EdTech companies use data analytics and process
                alignment to improve outcomes, transparency, and strategic planning.
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                ...
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    ERP and LMS Integration for Centralized Data
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Faculty Productivity and Operational Analytics
                  </span>
                </li>
              </ul>
