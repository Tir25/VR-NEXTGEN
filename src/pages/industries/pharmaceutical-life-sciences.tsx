        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              Specialized consulting for pharmaceutical and life sciences companies to drive
          ...
          >
            ...
            <div className='relative z-10 prose prose-lg max-w-none'>
              <h2 className='text-2xl font-bold text-white mb-6'>
                Driving Compliance, Quality, and Agility
              </h2>
              <p className='text-gray-300 leading-relaxed mb-4'>
                Pharmaceutical operations demand precision, documentation, and speed.
              </p>
              <p className='text-gray-300 leading-relaxed mb-6'>
                We support pharma manufacturers and research organizations in achieving process
                excellence, compliance accuracy, and digital transformation through data-driven
                insights.
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                ...
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Batch Yield Optimization and Changeover Reduction (SMED)
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Digital Documentation and Quality Dashboards
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  <div className='w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0'></div>
                  <span className='text-gray-300'>
                    Expiry, Wastage, and Material Flow Optimization
                  </span>
                </li>
              </ul>
              ...
              <p className='text-gray-300 leading-relaxed mb-4'>
                Better productivity, reduced quality deviations, and data-backed decision-making
                across production and quality teams.
              </p>
              <p className='text-white leading-relaxed text-lg'>
                💊 Efficiency meets compliance — powered by data.
              </p>
            </div>
          </div>
        </div>
