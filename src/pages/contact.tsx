    ...
    <Layout title='Contact' description='Get in touch with VR NextGEN Solutions'>
      <section id='contact-hero' className='section-hero relative min-h-screen py-16'>
        ...
        <div className='absolute inset-0 -z-20 overflow-hidden'>
          ...
          <div
            className='absolute bottom-1/4 right-1/6 w-48 h-48 bg-gold/10 rounded-full blur-2xl animate-pulse'
        ...
        <div className='max-w-6xl mx-auto px-4 md:px-6 lg:px-8'>
          ...
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-white/80 max-w-3xl mx-auto leading-relaxed'>
              Ready to transform your business? We&apos;re here to help you achieve your goals with
              data-driven strategies and expert guidance.
            </p>
          </div>
