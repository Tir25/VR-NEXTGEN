    ...
    >
      ...
      >
        <section className='relative z-10 max-w-none'>
          ...
          <p className='text-gray-700 leading-relaxed text-base md:text-lg mb-6'>
            Our strategic consulting framework helps you translate vision into structured execution
            by aligning your business model, people, and processes around data-backed decisions.
          </p>
          ...
          <div className='mt-8 rounded-xl border border-gold/30 bg-gold/10 p-6'>
            ...
            <p className='text-gray-800'>
              A focused business roadmap with measurable milestones that aligns growth, cost
