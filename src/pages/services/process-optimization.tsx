      ...
      >
        <section className='relative z-10 max-w-none'>
          <p className='text-gray-700 leading-relaxed text-base md:text-lg mb-6'>
            We specialize in Lean transformation, Six Sigma quality improvement, and advanced
            process engineering to drive measurable outcomes — reduced waste, faster cycle times,
            and enhanced productivity.
          </p>

          <h2 className='text-2xl font-bold text-black mb-4'>
            Lean Management – Eliminating Waste, Enhancing Flow
          </h2>
          <p className='text-gray-700 leading-relaxed mb-4'>
            Lean focuses on removing non-value-added activities and improving flow efficiency across
            your value chain. We help organizations establish visual management systems and
            continuous improvement frameworks that maximize every resource.
          </p>
          ...
          <h2 className='text-2xl font-bold text-black mb-4'>
            Six Sigma – Driving Quality Through Data
          </h2>
          <p className='text-gray-700 leading-relaxed mb-3'>
            Six Sigma applies data-driven statistical analysis to reduce process variation and
            defects. We deploy the DMAIC framework (Define, Measure, Analyze, Improve, Control) to
            ensure consistency, accuracy, and reliability across operations.
          </p>
          ...
          <p className='text-gray-700 leading-relaxed mb-8'>
            SMED is a game-changer for operations with frequent setups. We convert internal setups
            to external setups to drastically reduce downtime.
          </p>

          <h2 className='text-2xl font-bold text-black mb-4'>
            Total Quality Management (TQM) – Building a Culture of Excellence
          </h2>
          <p className='text-gray-700 leading-relaxed mb-3'>
            TQM embeds quality at every level — from procurement to delivery. We help establish a
            zero‑defect culture where prevention takes precedence over inspection.
          </p>
          ...
          <h2 className='text-2xl font-bold text-black mb-4'>
            Kaizen & Continuous Improvement – Sustaining Momentum
          </h2>
          <p className='text-gray-700 leading-relaxed'>
            Beyond frameworks and metrics, transformation requires cultural alignment. Our
            Kaizen-driven programs embed continuous improvement habits through structured training,
            goal-based projects, and recognition systems.
          </p>
        </section>
      </ServicePageShell>
    </Layout>
