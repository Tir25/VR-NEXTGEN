        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed'>
              Expert financial planning and investment strategy guidance to optimize your financial
          ...
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-12'>
            <div className='prose prose-lg max-w-none'>
              ...
              <p className='text-gray-600 leading-relaxed mb-6'>
                Our financial advisory services provide comprehensive financial planning, investment
                analysis, and risk management solutions to help organizations optimize their
                financial performance. We work with finance teams to develop strategies that support
              ...
              <div className='bg-gold/10 rounded-xl p-6 mb-8'>
                ...
                <p className='text-gray-600 leading-relaxed'>
                  Our financial experts bring deep industry knowledge and proven methodologies to
                  help you make informed financial decisions. We focus on creating sustainable
                  financial strategies that support your business objectives and drive long-term
                  value creation.
                </p>
              </div>
