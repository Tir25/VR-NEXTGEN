      ...
      >
        <section className='relative z-10 max-w-none'>
          <p className='text-gray-700 leading-relaxed text-base md:text-lg mb-4'>
            We help organizations transform complex datasets into clear, dynamic, and actionable
            visual stories — making performance insights accessible to everyone, from analysts to
            the CEO.
          </p>
          <p className='text-gray-700 leading-relaxed text-base md:text-lg mb-6'>
            Every leader needs the power of visibility — the ability to see trends, performance
            gaps, and progress across departments on a single page. Our visualization solutions
            ensure that executives can monitor KPIs, compare business units, and track strategic
            goals instantly, without diving into spreadsheets.
          </p>
          ...
          <div className='mt-8 rounded-xl border border-gold/30 bg-gold/10 p-6'>
            ...
            <p className='text-gray-800 mb-2'>
              A transparent, agile, and insight-driven organization that moves in one direction —
              forward.
            </p>
            <p className='text-gray-900 font-semibold'>
              We don’t just visualize data — we visualize decisions.
            </p>
          </div>
        </section>
      </ServicePageShell>
