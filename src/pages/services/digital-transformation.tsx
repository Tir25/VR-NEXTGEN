        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed'>
              Modernize your business with cutting-edge technology solutions that drive innovation
          ...
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-12'>
            <div className='prose prose-lg max-w-none'>
              ...
              <p className='text-gray-600 leading-relaxed mb-6'>
                Our digital transformation services help organizations modernize their operations,
                processes, and customer experiences through strategic technology adoption. We guide
                you through the complete digital journey, from strategy development to
              ...
              <div className='bg-gold/10 rounded-xl p-6 mb-8'>
                ...
                <p className='text-gray-600 leading-relaxed'>
                  Our digital transformation experts combine technical expertise with business
                  acumen to deliver solutions that drive real business value. We help you navigate
                  the complexities of digital change while ensuring your organization remains
