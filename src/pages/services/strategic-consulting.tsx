        ...
        <div className='max-w-4xl mx-auto px-4 md:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed'>
              Comprehensive business strategy development and implementation guidance to drive your
          ...
          <div className='bg-white rounded-2xl shadow-lg p-8 md:p-12'>
            <div className='prose prose-lg max-w-none'>
              ...
              <p className='text-gray-600 leading-relaxed mb-6'>
                Our strategic consulting services help organizations develop and implement
                comprehensive business strategies that drive sustainable growth and competitive
                advantage. We work closely with leadership teams to align business objectives with
              ...
              <div className='bg-gold/10 rounded-xl p-6 mb-8'>
                ...
                <p className='text-gray-600 leading-relaxed'>
                  ...
                  to help you navigate complex business challenges and capitalize on growth
                  opportunities. We focus on creating actionable strategies that deliver measurable
                  results.
                </p>
              </div>
