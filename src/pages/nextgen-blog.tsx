...
const blogPosts = [
  {
    ...
    excerpt: "Exploring emerging trends and technologies that will shape the digital landscape in the coming year.",
    ...
    featured: true,
    content: "Digital transformation continues to evolve rapidly, with 2024 bringing new opportunities and challenges for businesses worldwide..."
  },
  {
    title: "Data-Driven Decision Making: A Complete Guide",
    excerpt: "Learn how to leverage analytics and business intelligence to make informed strategic decisions.",
    author: "Michael Chen",
    ...
    featured: false,
    content: "In today's competitive business environment, data-driven decision making has become essential for success..."
  },
  {
    title: "Building Resilient Supply Chains in Uncertain Times",
    excerpt: "Strategies for creating robust and adaptable supply chain operations that can weather any storm.",
    ...
    featured: false,
    content: "Supply chain resilience has become a critical focus for organizations facing unprecedented challenges..."
  },
  {
    title: "The ROI of Process Automation: Real Numbers",
    excerpt: "Quantifying the benefits of automation with real-world examples and measurable outcomes.",
    author: "Lisa Wang",
    ...
    featured: false,
    content: "Process automation delivers measurable returns on investment across various business functions..."
  },
  {
    title: "Cybersecurity in the Age of Remote Work",
    excerpt: "Essential security measures and best practices for protecting distributed teams and data.",
    ...
    featured: false,
    content: "Remote work has fundamentally changed how we approach cybersecurity and data protection..."
  },
  {
    title: "Customer Experience Transformation: Beyond the Basics",
    excerpt: "Advanced strategies for creating exceptional customer experiences that drive loyalty and growth.",
    author: "Maria Garcia",
    ...
    featured: false,
    content: "Exceptional customer experience goes beyond basic satisfaction to create lasting relationships..."
  },
  {
    title: "AI and Machine Learning in Business Operations",
    excerpt: "How artificial intelligence is revolutionizing business processes and operational efficiency.",
    author: "Alex Patel",
    ...
    featured: false,
    content: "Artificial intelligence and machine learning are transforming how businesses operate and compete..."
  },
  {
    ...
    featured: false,
    content: "Sustainable business practices are no longer optional but essential for long-term success..."
  },
  {
    ...
    featured: false,
    content: "Digital marketing continues to evolve with new platforms, technologies, and consumer behaviors..."
  }
];
        ...
        <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1 md:gap-2">
              <span className="text-white font-semibold text-sm md:text-base truncate">{post.author}</span>
              {post.featured && (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs md:text-sm text-gray-400 truncate">Expert insights & industry trends</p>
              </div>
            </div>
