...
const CustomerStorySection = dynamic(
  () => import('@/components/sections/who-we-are/CustomerStorySection'),
  {
    ssr: false,
    loading: () => (
...
const CaseStudySection = dynamic(
  () => import('@/components/sections/who-we-are/CaseStudySection'),
  {
    ssr: false,
    loading: () => (
      <div className='py-16 md:py-24'>
...
export default function WhoWeArePage() {
  ...
  return (
    <Layout
      title='Who We Are'
      description='Insights, stories, and expertise from VR NextGEN Solutions'
    >
      {/* Hero Section */}
      <section
        id='who-we-are-hero'
            ...
            <div className='space-y-8 text-center max-w-4xl'>
              ...
              <div className='space-y-6'>
                ...
                <p className='text-lg md:text-xl text-white/80 leading-relaxed'>
                  Discover our expertise, success stories, and insights that drive business
