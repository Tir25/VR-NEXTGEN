...
export default function ServicePageShell({ badgeText, title, subtitle, children, cardTitle, cardBgUrl }: ServicePageShellProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-50 pt-8 pb-16 text-black">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <header className="text-center mb-6 md:mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gold/10 border border-gold/30 rounded-full text-gold text-sm font-medium mb-6 shadow-sm">
