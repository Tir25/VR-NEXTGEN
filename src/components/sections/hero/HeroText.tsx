        ...
        <div className='text-center space-y-8'>
          ...
          <div className='animate-fade-in-up'>
            <h1 className='hero-title text-3xl md:text-5xl lg:text-6xl font-bold text-gold leading-tight'>
              ...
              <span
                className={`inline-block w-0.5 h-8 md:h-10 lg:h-12 bg-gold ml-1 transition-opacity duration-100 ${
          ...
          <div className='animate-fade-in-up delay-1000'>
            <p className='text-base md:text-lg text-gray-200 max-w-4xl mx-auto leading-relaxed'>
              At <span className='text-gold font-semibold'>VR NextGen Solutions</span>, we empower
              businesses to achieve excellence through data, process, and strategy. Our end-to-end
              consulting approach helps organizations optimize operations, automate workflows, and
              make smarter, data-driven decisions. By aligning people, processes, and technology, we
