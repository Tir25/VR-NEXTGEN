...
const industries = [
  {
    ...
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.666.804 4.343a1 1 0 01-1.97.364l-.804-4.343L8.22 15H6a2 2 0 01-2-2V5zm5.603 3.5a1 1 0 10-1.206 1.206l1.206-1.206zM8 8.5a1 1 0 011.206-.794L8 8.5zm2 0a1 1 0 00-1.206-.794L10 8.5zm-2 2a1 1 0 011.206-.794L8 10.5zm2 0a1 1 0 00-1.206-.794L10 10.5z" clipRule="evenodd" />
      </svg>
    ),
  ...
  },
  {
    ...
    focus: ["Omnichannel Strategy", "Customer Analytics", "Inventory Management", "Digital Marketing"]
  },
  {
