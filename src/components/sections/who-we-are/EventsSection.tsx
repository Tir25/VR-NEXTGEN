...
const events = [
  {
    ...
    status: 'Upcoming',
    description:
      'Join industry leaders for insights on the latest digital transformation trends and strategies.',
  ...
  },
  {
    ...
    status: 'Upcoming',
    description:
      'Hands-on workshop covering advanced analytics techniques and business intelligence tools.',
      ...
      <div className='space-y-6'>
        ...
        <div className='space-y-3'>
          ...
          <div className='flex flex-wrap gap-2'>
            {event.speakers.map((speaker, index) => (
              <span
                key={index}
                className='px-3 py-1 bg-black/5 text-black text-xs font-medium rounded-full'
              >
                {speaker}
              </span>
            ))}
        ...
        <div className='pt-4 border-t border-gray-200 space-y-3'>
          <div className='flex items-center justify-between'>
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-medium ${getRegistrationColor(event.registration)}`}
            >
              {event.registration}
            </span>
          </div>
        ...
        <div className='max-w-6xl mx-auto px-4 md:px-6 lg:px-8'>
          <header className='text-center mb-16'>
            ...
            <p className='text-lg text-black/70 max-w-3xl mx-auto leading-relaxed'>
              ...
              designed to advance your business knowledge and skills.
            </p>
          </header>
