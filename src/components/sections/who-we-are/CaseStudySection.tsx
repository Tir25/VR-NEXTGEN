        ...
        <div className='space-y-3'>
          ...
          <div className='grid grid-cols-1 gap-2'>
            {Object.entries(study.outcomes).map(([key, value]) => (
              <div
                key={key}
                className='flex justify-between items-center py-2 px-3 bg-sand-yellow/5 rounded-lg'
              >
        ...
        <div className='space-y-3'>
          ...
          <div className='flex flex-wrap gap-2'>
            {study.technologies.map((tech, index) => (
              <span
                key={index}
                className='px-3 py-1 bg-sand-yellow/10 text-sand-yellow text-xs font-medium rounded-full'
              >
                {tech}
              </span>
            ))}
...
export default function CaseStudySection() {
  return (
    <ErrorBoundary>
      <section
        id='case-studies'
        className='section-why-choose relative py-16 md:py-24'
      ...
      >
        ...
        <div className='max-w-6xl mx-auto px-4 md:px-6 lg:px-8'>
          <header className='text-center mb-16'>
            ...
            <h2 className='text-4xl md:text-5xl font-bold text-gold mb-6'>Case Studies</h2>
            <p className='text-lg text-white/80 max-w-3xl mx-auto leading-relaxed'>
              In-depth analysis of our most successful projects, showcasing our methodology,
              approach, and the transformative results we deliver.
            </p>
          </header>
