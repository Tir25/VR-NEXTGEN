...
const customerStories = [
  {
    ...
    solution:
      'Comprehensive digital transformation strategy with cloud migration and process automation',
    results: [
    ...
    testimonial:
      'VR NextGEN transformed our entire operation. Their expertise in digital transformation was exactly what we needed.',
  ...
  },
  {
    ...
    solution:
      'Advanced analytics implementation with customer segmentation and predictive modeling',
    results: [
      '35% increase in sales',
      '50% improvement in customer retention',
      '20% boost in profit margins',
    ],
    testimonial:
      'The data insights provided by VR NextGEN revolutionized our understanding of our customers and market.',
  ...
  },
  {
    ...
    results: [
      ...
      '45% decrease in defects',
      '15% increase in output',
    ],
    testimonial:
      'Their operational expertise helped us achieve levels of efficiency we never thought possible.',
    ...
    >
      <div className='space-y-6'>
        ...
        <div className='space-y-4'>
          <div>
            <h4 className='text-sm font-semibold text-black/60 uppercase tracking-wider mb-2'>
              Challenge
            </h4>
        ...
        <div className='max-w-6xl mx-auto px-4 md:px-6 lg:px-8'>
          <header className='text-center mb-16'>
            ...
            <p className='text-lg text-black/70 max-w-3xl mx-auto leading-relaxed'>
              Real transformations, real results. Discover how we&apos;ve helped businesses across
              industries achieve their goals and drive sustainable growth.
            </p>
          </header>
