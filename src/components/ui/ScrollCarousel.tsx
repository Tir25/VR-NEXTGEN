...
const useScrollAnimations = (cardRefs: React.MutableRefObject<HTMLDivElement[]>) => {
  useEffect(() => {
...
export const ScrollCarousel = memo(
  forwardRef<HTMLDivElement, ScrollCarouselProps>(({ industries, className }, ref) => {
    ...
    const cards = useMemo(
      () =>
        industries.map((industry, index) => {
          const backgroundImage = hasBackgroundImage(industry.id)
            ? getBackgroundImagePath(industry.id)
            : null;
              ...
              >
                ...
                >
                  ...
                  <div className='relative z-10 p-4 sm:p-6 flex flex-col h-full'>
                    <div
                      className={`text-xs font-mono mb-2 tracking-wider font-semibold drop-shadow-lg ${
                    ...
                    <div
                      className='flex items-center justify-center mb-3 sm:mb-4 relative flex-shrink-0'
                      style={{ minHeight: '50px' }}
                    >
                      <i
                        className={`${industry.icon || 'fas fa-cube'} text-2xl sm:text-3xl md:text-4xl text-sand-yellow drop-shadow-lg`}
                      />
                    ...
                    <div className='flex-1 flex items-start justify-center min-h-0'>
                      <div className='text-center w-full'>
                        <p
                          className={`text-sm sm:text-base leading-relaxed font-medium drop-shadow-lg mb-3 ${
                        ...
                        <div
                          className={`text-xs sm:text-sm leading-relaxed font-medium drop-shadow-lg text-left ${
                ...
                >
                  ...
                  <div className='relative z-10 p-4 sm:p-6 flex flex-col h-full'>
                    ...
                    <div className='flex-1 flex items-start justify-start min-h-0 overflow-y-auto'>
                      <div
                        className={`text-sm sm:text-base leading-relaxed font-medium drop-shadow-lg text-left w-full ${
                          hasBackgroundImage(industry.id) ? 'text-white' : 'text-white/80'
                        }`}
                      >
                        {industry.description ? (
                          industry.description.split('\n').map((line, index) => (
                            <p
                              key={index}
                              className={`${index > 0 ? 'mt-2' : ''} font-medium leading-relaxed`}
                            >
                              {line}
                            </p>
                          ))
    ...
    return (
      ...
      >
        <div className='relative w-full max-w-full mx-auto px-4 sm:px-6'>
          <div className='flex flex-col items-center space-y-6 w-full'>{cards}</div>
        </div>
