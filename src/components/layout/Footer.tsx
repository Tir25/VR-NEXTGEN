      ...
      <div className='max-w-6xl mx-auto px-4 md:px-6 lg:px-8'>
        ...
        <div className='py-12 grid grid-cols-1 lg:grid-cols-4 gap-8'>
          ...
          <div className='lg:col-span-1'>
            ...
            <p className='text-sm text-white/70 mb-4 leading-relaxed'>{COMPANY_INFO.tagline}</p>
          ...
          <div className='lg:col-span-1'>
            ...
            <p className='text-sm text-white/70 mb-6'>
              Stay connected with us for the latest insights, industry updates, and business
              solutions.
            </p>
            <div className='flex flex-wrap gap-4' aria-label='Social media links'>
              <SocialIcon type='instagram' href={COMPANY_INFO.socialMedia.instagram} size='md' />
              <SocialIcon type='x' href={COMPANY_INFO.socialMedia.x} size='md' />
              <SocialIcon type='facebook' href={COMPANY_INFO.socialMedia.facebook} size='md' />
              <SocialIcon type='youtube' href={COMPANY_INFO.socialMedia.youtube} size='md' />
              <SocialIcon type='linkedin' href={COMPANY_INFO.socialMedia.linkedin} size='md' />
              <SocialIcon
                type='gmail'
